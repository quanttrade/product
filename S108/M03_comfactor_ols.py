...
F0 = F0.groupby('tradeDate').apply(lambda x:com_ols_factor(x))
...
F.to_pickle('factor_sec_smoothing_ols.pkl')
...
F[F.tradeDate.isin(tref1.tradeDate.tolist())].to_pickle('factor_sec_smoothing_test_ols.pkl')
F[F.tradeDate.isin(tref_month)].to_pickle('factor_sec_smoothing_month_ols.pkl')