# -*- coding: utf-8 -*-
"""
Created on Sat Feb 25 10:51:05 2023
将选股和确定权重的逻辑在backtrader外部做，形成类似如下的调仓表，该表按月调仓（再平衡），并给出了各选定股票的权重
@author: adair2019
"""
...
class StockSelectStrategy(bt.Strategy):
    ...
    def __init__(self):
        ...
        self.buy_stock = pd.read_csv(os.path.join(pn0,"trade_info.csv"), 
                                     parse_dates=['trade_date'],dtype = {'sec_code':str}) 
