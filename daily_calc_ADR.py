...
list_of_files = glob.glob('C:/Users/ASUS//Documents/GitHub/test/ADR/ADR/ZX02-program/program/计算结果/支线任务2-*操作明细-1.50.csv')
...
msg = MIMEMultipart()
msg['Subject'] = "daily ADR levels Taiwan"+yst 
...
emaillist = [elem.strip().split(',') for elem in recipients]
msg = MIMEMultipart()
msg['Subject'] = "daily ADR levels India"+yst 
msg['From'] = 'caifengsteven@gmail.com'
