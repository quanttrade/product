...
from bac_toolS43_V4_20211018 import get_single_data,result_str
...
if __name__ == "__main__":
    ...
    for dtype in ['csi']:#index_id_zx02+['hk_ggt','csi','US','HK','forex_day','as51', 'topix', 'twse','hsce']:
        tn = 's43_%s_20210630_%s' % (dtype.lower(),result_str)
        begin = '2010-10-01'    
